...
public class NegaMaxBot extends CompetitorBot {
    ...
    public NegaMaxBot() throws InvalidBotException {
        this.setBotName("NegaMax5 Profondeur = " + MAX_DEPTH);
    ...
    public double[] getDecision(Board board) {
        return new NegaMaxNode(board, 0, board.getCurrentPlayer(), Board.otherPlayer(board.getCurrentPlayer()), Double.NEGATIVE_INFINITY, Double.POSITIVE_INFINITY).getDecision();
    }
