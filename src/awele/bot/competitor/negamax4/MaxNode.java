 ...
 */
public class MaxNode extends NegaMaxNode
{
    /**
     ...
     */
    MaxNode (Board board, int depth, double alpha, double beta, int color)
    {
        super (board, depth, alpha, beta, color);
    }
    ...
    {
        return new MaxNode(board, depth, alpha, beta, color);
    }
